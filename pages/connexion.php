        ...
        <div class="bg-[#e0f2fe] flex rounded-xl shadow-lg max-w-3xl p-5">
            ...
            <div class="md:w-1/2 px-&-">
                ...
                <form action="" class="flex flex-col gap-4">
                    <input type="text" name="userName" placeholder="Username" id="userName" class="p-2 mt-8 rounded-xl border w-full">
                    <div class="relative">
                        <input type="password" name="password"
                        placeholder="Password" id="password" class="p-2 rounded-xl border w-full">
